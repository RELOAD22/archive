...
def lm_check():
    ...
    if(docker_check() and criu_check() and kernel_check()) is False:
...
def docker_check():
    ...
    lines = docker_version.decode().split('\n')
    for line in lines:
...
def kernel_check():
    ...
    kernel_version = kernel_version.decode()
